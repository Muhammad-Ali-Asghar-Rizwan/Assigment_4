def main():
   ...
   # Print out all of the ages!
    ...
    print(f"Beth is {beth} years older than Anton.")
    print(f"Chen is {beth} years older than Beth.")
    print("Drew is as old as Chen's age plus Anton's age.")
    print("Ethan is the same age as Chen.")
